...
Array.from(ready).forEach(function(element) {
      element.addEventListener('click', function(){
        ...
        const order = this.parentNode.parentNode.parentNode.childNodes[5].innerText //not finding it 
        const status = this.parentNode.parentNode.parentNode.childNodes[7].innerText
        const barista = this.parentNode.parentNode.parentNode.childNodes[9].innerText
